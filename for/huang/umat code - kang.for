...
JX      10*NSLPTL+1 - 11*NSLPTL£º  the back stress of each slip system
CFIX
CFIX    11*NSLPTL+1             : total cumulative shear strain on all 
C                                 slip systems (sum of the absolute 
C                                 values of shear strains in all slip 
C                                 systems)
C
CFIX    11*NSLPTL+1 -11*NSTATV-4  : additional parameters users may need 
